...
import type { MotorradChecklistContent } from "@/components/Motorrad/types";

type ChecklistSectionProps = {
  content: MotorradChecklistContent;
};
...
export default function ChecklistSection({ content }: ChecklistSectionProps) {
  ...
  return (
    <div className="w-full">
      <div className="mt-14 rounded-3xl bg-white p-8">
        <motion.div
        ...
        <div
          className="flex h-[220px] justify-center gap-6 overflow-x-auto px-4 pb-4 pt-[10px]"
