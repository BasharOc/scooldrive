...
import type { AutoAnhaengerHeroContent } from "@/components/AutoAnhaenger/types";
import type { Locale } from "@/types/i18n";

type HeroSectionProps = {
  content: AutoAnhaengerHeroContent;
  locale: Locale;
};
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden px-[5vw]">
      ...
      >
        ...
        <h1 className="text-5xl font-extrabold leading-tight tracking-wide uppercase shadow-xl sm:text-6xl lg:text-7xl">
