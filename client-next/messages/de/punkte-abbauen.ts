export const PUNKTE_ABBAUEN_DE = {
  seo: {
    title: "Punkte abbauen Lüneburg – Fahreignungsseminar (FES) bei Scooldrive",
    description:
      "Jetzt Punkte in Flensburg abbauen: Fahreignungsseminar in Lüneburg bei Scooldrive. Schnelle Termine, erfahrene Trainer und effektives Training.",
  },
  header: {
  ...
  structure: {
    ...
    cards: [
      ...
      },
      {
        ...
        meta: "Bis zu 3 Teilnehmer gleichzeitig",
        badge: "30 Minuten",
      },
      {
        icon: "users",
