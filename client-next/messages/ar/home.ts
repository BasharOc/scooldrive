...
export const HOME_AR: HomeContent = {
  ...
  hero: {
    badge: "نجعلك متنقلاً",
    title1: "رخصتك. حريتك.",
    title2: "لونيبورغ الخاصة بك.",
    subtitle: "معنا ستجلس قريبًا خلف المقود بنفسك.",
    features: [
      "دروس قيادة مرنة – أيضًا مساءً وفي عطلة نهاية الأسبوع",
      "مجموعات صغيرة ورعاية شخصية",
      "نسبة نجاح عالية في امتحان TÜV",
      "مدربوك يعرفون مسارات الامتحان في لونيبورغ",
    ],
    cta: "سجّل الآن",
    socialProof: "★★★★★ 149 تقييمًا · رقم 1 في البلدة القديمة في لونيبورغ",
  ...
  personalApproach: {
    ...
    features: [
      {
        title: "مواعيد مرنة",
        description: "دروس قيادة تتناسب مع حياتك",
      },
      {
        title: "مدربك الثابت",
        description: "بجانبك من الدرس الأول حتى الامتحان",
      },
      {
        title: "معدل نجاح عالٍ",
        description: "تدريب موجّه على مسارات الامتحان في لونيبورغ",
      },
      {
        title: "وتيرتك، خطتك",
        description: "لا باقة قياسية – نتكيف معك",
      },
    ],
    stepsHeading: "رخصتك في 3 خطوات",
    steps: [
      {
        title: "المحادثة الأولى",
        description:
          "نتعرف عليك — على جدولك، وتيرتك، وأهدافك. لا باقة قياسية، بل خطة تناسبك.",
      },
      {
        title: "دروس القيادة",
        description:
          "مواعيد مرنة، مدرب ثابت يعرفك حقًا. أنت من يحدد الوتيرة.",
      },
      {
        title: "الامتحان",
        description:
          "نعدّك تحديدًا لمسارات الامتحان في لونيبورغ — حتى تدخل الامتحان بثقة واطمئنان.",
      },
    ],
    cta: "ابدأ مجانًا الآن",
    ctaPath: "/anmelden",
  },
  reviews: {
