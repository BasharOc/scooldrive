export const PUNKTE_ABBAUEN_EN = {
  seo: {
    title: "Reduce Points Lüneburg – ASF Seminar at Scooldrive",
    description:
      "Reduce points in Flensburg now: ASF seminar in Lüneburg at Scooldrive. Fast appointments, experienced trainers and effective training.",
  },
  header: {
  ...
  structure: {
    ...
    cards: [
      ...
      },
      {
        ...
        meta: "Up to 3 participants simultaneously",
        badge: "30 minutes",
      },
      {
        icon: "users",
