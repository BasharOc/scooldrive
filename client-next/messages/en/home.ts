...
export const HOME_EN: HomeContent = {
  seo: {
    title: "Scooldrive Driving School Lüneburg – Get your license now",
    description:
      "Get your driver's license in Lüneburg with modern training, personal support and fair pricing at Scooldrive.",
  },
  hero: {
  ...
  personalApproach: {
    ...
    header2: "so you won't get from us a standard solution",
  ...
  trafficRules: {
    title: "OUR OWN TRAFFIC RULES.",
    subtitle: "You can rely on this:",
    badgeText: ["TRAINING", "WITH BEST", "QUALITY"],
    rules: [
  ...
  faq: {
    title: "YOUR QUESTION NOT LISTED? CONTACT US.",
    items: [
      {
      ...
      {
        question: "WHAT DOCUMENTS DO I NEED TO REGISTER FOR THE DRIVER'S LICENSE?",
        answer:
