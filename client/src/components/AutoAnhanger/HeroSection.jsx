...
const heroContent = {
  ...
  EN: {
    badge: "Trailer License Class BE",
    title: [
      "Your big trailer license.",
      "So everything arrives,",
      "where you want it.",
    ],
    description: [
      "Trailer license for larger loads",
      "Practice-oriented training",
      "Learn flexibly and efficiently",
    ],
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden px-[5vw]">
      ...
      >
        ...
        {/* Titel */}
        <h1
          className={`text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-tight tracking-wide uppercase shadow-xl ${
            isArabic ? "rtl" : ""
          }`}
        >
