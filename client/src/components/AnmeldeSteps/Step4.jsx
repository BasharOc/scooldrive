...
const Step4 = ({ formData, setFormData, errors, langContent }) => (
  <div>
    <h2 className="text-3xl font-bold text-black mb-8 text-center">
      {langContent.title}
    </h2>
    <div className="max-w-lg mx-auto space-y-6">
      {langContent.options.map(({ key, label, desc, icons }) => (
        <div
          key={key}
    ...
    {errors.getriebe && (
      <p className="text-red-500 mt-4 text-center">{errors.getriebe}</p>
    )}
  </div>
);
