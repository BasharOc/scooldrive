...
const heroContent = {
  DE: {
    badge: "Motorradführerschein Klasse A",
    title: ["Dein Motorradführerschein.", "Wie ein Auto. Nur ohne Stützräder."],
    description: [
      "Ab 15 Jahren",
      "In wenigen Tagen auf die Straße",
      "Klein anfangen — Problemlos upgraden",
    ],
    buttonText: "Jetzt Unabhängig werden",
  },
  EN: {
    badge: "Motorcycle License Class A",
    title: [
      "Your motorcycle license.",
      "Like a car. Just without training wheels.",
    ],
    description: [
      "From 15 years old",
      "On the road in just a few days",
      "Start small — Upgrade easily",
    ],
      ...
      >
        ...
        >
          {lang.title.map((line, index) => (
            <span
              key={index}
              className="bg-black text-white rounded-md text-2xl sm:text-xl lg:text-5xl block"
              style={{
                padding: "0.1em 0.2em",
              }}
            >
