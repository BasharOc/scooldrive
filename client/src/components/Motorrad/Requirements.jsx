...
import { FiCheck, FiUser, FiCreditCard, FiEye, FiShield } from "react-icons/fi";
...
const requirementsContent = {
  DE: [
    ...
    {
      icon: <GiFullMotorcycleHelmet className="w-6 h-6" />,
      title: "Schutzbekleidung",
      description:
        "Schutzbekleidung nach EU-Norm (z.B. Helm, Handschuhe, Jacke, Hose, Stiefel)",
    },
    {
  ...
  EN: [
    ...
    },
    {
      ...
      description:
        "Protective clothing according to EU standards (e.g., helmet, gloves, jacket, pants, boots)",
    },
    {
      icon: <FiShield className="w-6 h-6" />,
...
const Requirements = () => {
  ...
  return (
    <div className="w-full">
      <div className="bg-white rounded-3xl p-8 mt-14">
        <motion.div
        ...
        <div
          className="flex pt-[10px] h-[220px] overflow-x-auto gap-6 pb-4 px-4 justify-center"
